...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        BodyDategroupBox->setGeometry(QRect(270, 80, 191, 131));
        ...
        RaceLabel->setGeometry(QRect(10, 30, 80, 20));
        ...
        SubRaceLabel->setGeometry(QRect(120, 30, 80, 20));
        ...
        AlignmentComboBox->setGeometry(QRect(110, 110, 100, 20));
...
"selection-background-color: rgb(255, 6, 176);"));
        ...
        race_mod_cha_label->setGeometry(QRect(110, 350, 80, 25));
        ...
        race_mod_con_label->setGeometry(QRect(110, 188, 80, 25));
        ...
        race_mod_str_label->setGeometry(QRect(110, 80, 80, 25));
        ...
        race_mod_int_label->setGeometry(QRect(110, 242, 80, 25));
        ...
        race_mod_wis_label->setGeometry(QRect(110, 296, 80, 25));
        ...
        race_mod_dex_label->setGeometry(QRect(110, 134, 80, 25));
